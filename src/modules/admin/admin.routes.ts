...
import { create as createFeatured, update as updateFeatured, remove as removeFeatured } from "./featured.controller";
...
adminRouter.patch("/featured/:id", updateFeatured); // PATCH  /api/admin/featured/:id
adminRouter.delete("/featured/:id", removeFeatured); // DELETE /api/admin/featured/:id